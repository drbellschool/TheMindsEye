  ...
  return (
    <aside className="sanborn-atlas-navigator">
      ...
      <section className="sanborn-atlas-navigator__section">
        ...
        <button className="sanborn-button sanborn-button--primary" disabled={readOnly || !draft.editionYear} onClick={() => onSaveAtlas(draft)} type="button">
          Save atlas
        </button>
      </section>
      ...
      <section className="sanborn-atlas-navigator__section">
        ...
        <button className="sanborn-button sanborn-button--primary" disabled={readOnly || !selectedAtlasId} onClick={onSavePages} type="button">
          Save page order
        </button>
      </section>
    </aside>
